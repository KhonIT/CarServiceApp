...
function Get_All_service(){
	$.ajax({
		url: backend_url+'Customer_Service/Get_All_Payed',
		data: {},
		dataType: "json",
		type: "POST",
		...
		success: function (data)
			{
				...
				$.each(data, function(idx, obj) {
					$("#tbody_list").append('<tr><td>'+i+'</td><td>'+obj.cus_name+'</td><td>'+obj.cus_tel+'</td><td>'+obj.cus_car_regis_number+'-'+obj.cus_car_brand+'-'+obj.cus_car_model+'-'+obj.cus_car_color+'</td><td>'+obj.created_date+'</td><td align="center"><span class=" glyphicon glyphicon-print print-data icon " id='+obj.id+'></span></td><td align="center"><span class=" glyphicon glyphicon-remove remove-data icon " id='+obj.id+'></span></td></tr>');
						i++;
					});
			}
	});
