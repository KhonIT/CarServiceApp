...
class Service_Model extends CI_Model{
	 ...
	 public function Get_By_Car_Size($car_size){
			$sql = 'select service_id,service_name,price,car_size  from service where is_deleted = 0 and car_size =?';
		  $query = $this->db->query($sql, array($car_size));
			return $query->result();
	 }
